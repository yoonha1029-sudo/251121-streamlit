...
def render_card(title, desc, file_bytes, file_name, source_label, source_url):
    with st.container():
        ...
        st.markdown(f"출처 : [{source_label}]({source_url})")
